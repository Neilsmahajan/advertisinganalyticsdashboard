...
import { LogOut, Search, BarChart3, LineChart, PieChart, BarChart, Megaphone, Mail } from "lucide-react"
    ...
    <div className="container px-4 py-12 md:px-6 md:py-20">
      <div className="mx-auto max-w-5xl space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-gray-500 dark:text-gray-400 md:text-lg">Welcome, Neil Mahajan!</p>
          <p className="text-gray-500 dark:text-gray-400">Manage your profile information and saved queries here.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Access your saved queries for different services</CardDescription>
            </CardHeader>
            <CardContent>

...
export default function TrackingDataPage() {
  ...
  const handleAnalyze = () => {
    ...
    setTimeout(() => {
      ...
      setResults({
        found: ["Google Analytics (GA4)", "Google Tag Manager", "Facebook Pixel", "LinkedIn Insight Tag", "HotJar"],
      })
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Find Analytics and Tracking Data</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select value={selectedQuery} onValueChange={handleSelectChange}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="previous-query-1">My Website Analysis</SelectItem>
                    <SelectItem value="previous-query-2">Competitor Analysis</SelectItem>
                  </SelectContent>
                </Select>
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tracking services found on your website</CardDescription>
          </CardHeader>
          <CardContent>
            {!results && !isAnalyzing && (
              <div className="flex items-center justify-center h-[300px] bg-muted/20 rounded-md">
                <p className="text-muted-foreground">Enter a URL and click Analyze to see results</p>
              </div>
            )}

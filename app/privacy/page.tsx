      ...
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-500 dark:text-gray-400">
            <li>
              <span className="font-medium text-foreground">Personal Information:</span> When you create an account, we
              collect details such as your name, email address, and any other data you provide during registration.
            </li>
            <li>
              <span className="font-medium text-foreground">Usage Data:</span> We track how you interact with our
              website, including the services you use, the pages you visit, and your preferences, to enhance your
              experience.
            </li>
            <li>
              <span className="font-medium text-foreground">Ad Platform Data:</span> If you connect your ad accounts, we
              access campaign performance metrics, but we never modify or interact with your ad campaigns.
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-500 dark:text-gray-400">We Use Your Information To:</p>
          <ul className="list-disc pl-6 space-y-2 text-gray-500 dark:text-gray-400">
            <li>Provide access to our platform and its features.</li>
            <li>Improve and personalize your experience.</li>
            <li>Communicate updates, promotional offers, and support-related information.</li>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-500 dark:text-gray-400">Your Have The Right To:</p>
          <ul className="list-disc pl-6 space-y-2 text-gray-500 dark:text-gray-400">

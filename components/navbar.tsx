      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-2">
          <Link href="/" className="flex items-center gap-2">
            ...
            />
            <span className="hidden font-bold sm:inline-block">Advertising Analytics</span>
          </Link>
        </div>
              ...
              <div className="flex flex-col gap-6 pt-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2 pl-4">
                    <Link href="/dashboard/tracking-data" className="text-sm" onClick={() => setIsMenuOpen(false)}>
                      Tracking Data
                    </Link>
                    <Link href="/dashboard/google-analytics" className="text-sm" onClick={() => setIsMenuOpen(false)}>
                      Google Analytics
                    </Link>
                    <Link href="/dashboard/google-ads" className="text-sm" onClick={() => setIsMenuOpen(false)}>
                      Google Ads
                    </Link>
                    <Link href="/dashboard/meta-ads" className="text-sm" onClick={() => setIsMenuOpen(false)}>
                      Meta Ads
                    </Link>
                    <Link href="/dashboard/microsoft-ads" className="text-sm" onClick={() => setIsMenuOpen(false)}>
                      Microsoft Ads
                    </Link>
                  </div>
                </div>
                ...
                <Link href="/account" className="text-lg font-medium" onClick={() => setIsMenuOpen(false)}>
                  My Account
                </Link>
